...
function App() {
  ...
  const getEnvironmentConfig = (_envType: string) => {
    ...
    return {
      ...
      s3Url: currentEnv.s3Url || 'https://s3.ap-south-1.amazonaws.com/staging-merchants-assets',
      funnelUrl: currentEnv.funnelUrl || 'https://staging-funneltrack.zestmoney.in',
      ...
      google_login_client_id: currentEnv.googleClientId || '508197139032-5eanucd3nfoa49iikn15ahusjeesc7vp.apps.googleusercontent.com',
      ...
      finoramicClientId: currentEnv.finoramicClientId || 'ae717c9e-5b4f-4a54-99c5-ec26e1937b82',
      finoramicClient: 'zestmoney',
      finoramicCallback: '/authentication/finoramic-callback',
      featuresApiKey: currentEnv.apiKey || '14FTv6F6dj94qA3AiTGyEacUKbQRCj0gZT3C0TKe',
    ...
    const initializeApp = async () => {
      try {
        ...
        initializeErrorHandling({
          ...
          logEndpoint: (config.baseUrl || 'https://staging-auth.zestmoney.in') + '/logs'
        });
              ...
              <ErrorBoundary level="component" showErrorDetails={false}>
                <Routes>
                  ...
                  <Route
                    ...
                    element={
                      <RedirectComponent
                        environmentType={import.meta.env.VITE_ENVIRONMENT || 'Local'}
                        clientName={import.meta.env.VITE_CLIENT_NAME || 'default'}
                        authVersion="V3"
                        onGetToken={(_token) => {
